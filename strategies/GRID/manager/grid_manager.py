...
class GridManager:
    def __init__(self, client, config, client_pub=None):
        ...
        try:
            ...
            # ✅ FIX: Levels übergeben
            self.position_tracker.set_levels(self.levels)
    ...
    def _maybe_rebalance(self) -> None:
        ...
        # ✅ FIX: PositionTracker mit neuen Levels aktualisieren
    ...
    def handle_position_close(self, position_data: Dict[str, Any]):
        """Delegiert an PositionTracker mit aktuellem Preis"""
